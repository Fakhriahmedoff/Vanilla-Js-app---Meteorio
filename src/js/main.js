...
searchCityForm.addEventListener('submit', (evt) =>{
    evt.preventDefault();
    weather.innerHTML='<img class="loading" src="https://vtl.com.vn/images/loading2.gif" alt="Loading..." />'
        ...
        .then((results) => {
            ...
            weather.innerHTML = `<div class="card weather-card">
                    <div class="card-body">
                        ...
                        <div class="media">
                            <img src="${current.weather_icons[0]}" class="align-self-start mr-3" alt="${current.weather_descriptions[0]}">
